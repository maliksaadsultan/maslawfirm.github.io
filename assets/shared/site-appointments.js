(function () {
  ...
  var BUSINESS = {
    ...
    phoneRaw: CONTACT_PHONE_WHATSAPP,
  ...
  function addAppointmentMeta(form, title) {
    ...
    meta.innerHTML =
      ...
      '<a href="' + BUSINESS.whatsappUrl + '" target="_blank" rel="noopener noreferrer" aria-label="Chat with tax lawyer on WhatsApp">WhatsApp</a>' +
      '<a href="' + BUSINESS.mapsUrl + '" target="_blank" rel="noopener noreferrer">Open Map</a>' +
      "</div>";
  ...
  function handleSubmit(form, title) {
    ...
    form.addEventListener("submit", function (event) {
      ...
      var lines = [
        "Hello, I would like to discuss a tax matter with a tax lawyer.",
        "",
